...
async function run() {
  const result = await pimms.customers.list({});
...
import { customersList } from "pimms/funcs/customersList.js";
...
async function run() {
  const res = await customersList(pimms, {});
...
async function run() {
  const result = await pimms.customers.create();
...
```typescript
import { PimmsCore } from "pimms/core.js";
import { customersCreate } from "pimms/funcs/customersCreate.js";
...
async function run() {
  const res = await customersCreate(pimms);
...
async function run() {
  const result = await pimms.customers.get({
    id: "<id>",
  });
...
```typescript
import { PimmsCore } from "pimms/core.js";
import { customersGet } from "pimms/funcs/customersGet.js";
...
async function run() {
  const res = await customersGet(pimms, {
    id: "<id>",
  });
...
async function run() {
  const result = await pimms.customers.update({
    id: "<id>",
  });
...
```typescript
import { PimmsCore } from "pimms/core.js";
import { customersUpdate } from "pimms/funcs/customersUpdate.js";
...
async function run() {
  const res = await customersUpdate(pimms, {
    id: "<id>",
  });
...
async function run() {
  const result = await pimms.customers.delete("<id>");
...
```typescript
import { PimmsCore } from "pimms/core.js";
import { customersDelete } from "pimms/funcs/customersDelete.js";
...
async function run() {
  const res = await customersDelete(pimms, "<id>");
